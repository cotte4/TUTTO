...
export const WrenchScrewdriverIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17 17.25 21A2.652 2.652 0 0 0 21 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.664 1.208-.766M11.42 15.17l-4.636 4.636a2.121 2.121 0 0 1-3 0l-1.121-1.121a2.121 2.121 0 0 1 0-3l4.636-4.636m1.028-2.472a4.585 4.585 0 0 0-1.296-1.121c-1.254-1.254-3.284-1.254-4.538 0l-1.121 1.121c-1.254 1.254-1.254 3.284 0 4.538a4.585 4.585 0 0 0 1.121 1.296m1.028-2.472.335-.335m-.335.335a2.625 2.625 0 0 0 3.536 3.536m-3.536-3.536c.386-.386.752-.828 1.07-1.314m-1.07 1.314-.335.335m.335-.335.335-.335m0 0 .335.335m0 0 .335-.335m0 0-3.536-3.536m3.536 3.536.335.335" />
  </svg>
);
